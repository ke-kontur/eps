...
public class IdentifyMeanType
{
    ...
    /** 
     * Get the 'IdentBreakFlag' element value. Признак нарушения средств идентификации ("0" - не нарушено, "1" - нарушено)
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'IdentBreakFlag' element value. Признак нарушения средств идентификации ("0" - не нарушено, "1" - нарушено)
     * 
