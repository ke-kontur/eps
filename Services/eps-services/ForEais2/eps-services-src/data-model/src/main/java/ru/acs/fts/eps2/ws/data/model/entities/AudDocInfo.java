...
import ru.acs.fts.eps2.ws.data.model.pks.EdeclAudDocInfoPK;

@Entity
@Table( name = "EDECL_AUD_DOC_INFO" )
@IdClass( EdeclAudDocInfoPK.class )
public class AudDocInfo
{
	@Id
	...
	@Column( name = "AUDDOC_EADID", length = 36, nullable = true )
	...
	*/
	...
	/*
	@ManyToOne
	@JoinColumn( name = "AUDDOC_CMDREFGUID", nullable = false, insertable = false, updatable = false )
	private AudCommand refCmd;
	*/
	...
	*/
	...
	/*
	public void setRefCmd( AudCommand refCmd ) { this.refCmd = refCmd; }
	public AudCommand getRefCmd( ) { return refCmd; }
	*/
