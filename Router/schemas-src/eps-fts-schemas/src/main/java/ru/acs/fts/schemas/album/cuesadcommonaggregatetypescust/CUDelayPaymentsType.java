...
public class CUDelayPaymentsType
{
    ...
    /** 
     * Get the 'DelayDocumentNumber' element value. Ќомер документа, на основании которого предоставлена отсрочка 
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'DelayDocumentNumber' element value. Ќомер документа, на основании которого предоставлена отсрочка 
     * 
    ...
    /** 
     * Get the 'DelayDocumentDate' element value. ƒата документа, на основании которого предоставлена отсрочка 
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'DelayDocumentDate' element value. ƒата документа, на основании которого предоставлена отсрочка 
     * 
    ...
    /** 
     * Get the 'DelayDate' element value. ƒата уплаты
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'DelayDate' element value. ƒата уплаты
     * 
     * @param delayDate
     */
