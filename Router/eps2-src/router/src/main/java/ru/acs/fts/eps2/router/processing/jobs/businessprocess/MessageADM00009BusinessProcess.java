...
public class MessageADM00009BusinessProcess extends BusinessProcess
{
	@Override
		...
		throws Exception
	{
		 ...
		 * надо подготовить список ADM.00010'ов для отправки
		 */
		...
		for ( EadRequest request : mappings.keySet( ) )
		{
			...
			EDEnvelope respEnvelope = EadToTransportMapper.makeEnvelope( 
				request, response, 
				MessageType.ADM_00010, MessageType.ADM_00001, 
				documentId, 
				BusinessSystems.EPS, 
				jobBatchContext 
			);
