...
/** 
 * ДТ и ТД. Внутренний формат. Транспортные средства при прибытии/убытии. Гр. 18, 26 ДТ
 */
public class ESADinDepartureArrivalTransportType extends CUTransportMeansType
{
