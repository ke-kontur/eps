...
public class ReplacementBillInfoType
{
    ...
    /** 
     * Get the 'FormingAircompany' element value. јвиакомпани€, составл€юща€ замен€ющую накладную
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'FormingAircompany' element value. јвиакомпани€, составл€юща€ замен€ющую накладную
     * 
    ...
    /** 
     * Get the 'SubmitAirport' element value. јэропорт подачи замен€ющей накладной
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'SubmitAirport' element value. јэропорт подачи замен€ющей накладной
     * 
     * @param submitAirport
     */
    ...
    /** 
     * Get the list of 'Remarks' element items. «амечани€, касающиес€ найденных депеш
     * 
     * @return list
     */
    ...
    /** 
     * Set the list of 'Remarks' element items. «амечани€, касающиес€ найденных депеш
     * 
     * @param list
     */
    ...
    /** 
     * Get the 'OperatorSupplyCountry' element value. Ќазначенный оператор страны подачи депеш
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'OperatorSupplyCountry' element value. Ќазначенный оператор страны подачи депеш
     * 
