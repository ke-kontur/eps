...
/** 
 * »нформаци€ о транспортном средстве
 * 
...
public class DTTransportType
{
    ...
    public static class TransportMeans
    {
        ...
        /** 
         * Get the 'TransportIdentifier' element value. »дентификатор. Ќомер транспортного средства, название судна, номер авиарейса...
         * 
         * @return value
         */
        ...
        /** 
         * Set the 'TransportIdentifier' element value. »дентификатор. Ќомер транспортного средства, название судна, номер авиарейса...
         * 
