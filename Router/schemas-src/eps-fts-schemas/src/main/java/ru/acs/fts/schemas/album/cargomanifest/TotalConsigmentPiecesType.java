...
/** 
 * —ведени€ об общем количестве товара по накладной при частичной погрузке
 */
public class TotalConsigmentPiecesType
{
    ...
    /** 
     * Get the 'NumberPieces' element value.  оличество мест товара по накладной
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'NumberPieces' element value.  оличество мест товара по накладной
     * 
     * @param numberPieces
     */
