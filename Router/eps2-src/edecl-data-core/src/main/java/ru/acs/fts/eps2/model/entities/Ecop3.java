...
public class Ecop3
{
	...
	public String getSpSimpl( )
	{
		return spSimpl;
	}

	public void setSpSimpl( String spSimpl )
	{
		this.spSimpl = spSimpl;
	}
	...
	public String getpLocat( ) // NO_UCD (unused code)
	{
		return pLocat;
	}

	public void setpLocat( String pLocat ) // NO_UCD (unused code)
	{
		this.pLocat = pLocat;
	}
