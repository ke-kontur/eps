...
/** 
 * Разрешение представления документов в установленный срок/Разрешение представления документов в графическом виде
 */
public class PermitDelayDocsType extends BaseDocType
{
    ...
    /** 
     * Get the 'DocSign' element value. Тип документа: 0 - Разрешение представления документов в установленный срок, 1- Разрешение представления документов в графическом виде
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'DocSign' element value. Тип документа: 0 - Разрешение представления документов в установленный срок, 1- Разрешение представления документов в графическом виде
     * 
     * @param docSign
     */
