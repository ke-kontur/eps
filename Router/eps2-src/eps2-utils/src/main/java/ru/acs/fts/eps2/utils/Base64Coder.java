...
{
	public static byte[ ] encode( String str, String encoding )  // NO_UCD (unused code)
	...
	public static String decode( byte[ ] bytes, String encoding )  // NO_UCD (unused code)
		throws UnsupportedEncodingException
	{
		return new String( Base64.decodeBase64( bytes ), encoding );
	}
	
	public static String decode( String bytes, String encoding )  // NO_UCD (use private)
		throws UnsupportedEncodingException
	{
		return new String( Base64.decodeBase64( bytes ), encoding );
	}
