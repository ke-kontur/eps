...
/** 
 * »змерение и определение характеристик товаров (с частичной разборкой/с полной разборкой)
 */
public class FeatureFindingType
{
    ...
    /** 
     * Get the 'FeatureFindingGoods' element value. ѕризнак измерени€ и определени€ характеристик товаров с полной разборкой
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'FeatureFindingGoods' element value. ѕризнак измерени€ и определени€ характеристик товаров с полной разборкой
     * 
    ...
    public static class Choice
    {
        ...
        /** 
         * Get the 'WTakeSampleFlag' element value. »змерение и определение характеристик товаров со вз€тием проб и образцов
         * 
         * @return value
         */
        ...
        /** 
         * Set the 'WTakeSampleFlag' element value. »змерение и определение характеристик товаров со вз€тием проб и образцов
         * 
        ...
        /** 
         * Get the 'NoTakeSampleFlag' element value. »змерение и определение характеристик без вз€ти€ проб и образцов
         * 
         * @return value
         */
        ...
        /** 
         * Set the 'NoTakeSampleFlag' element value. »змерение и определение характеристик без вз€ти€ проб и образцов
         * 
