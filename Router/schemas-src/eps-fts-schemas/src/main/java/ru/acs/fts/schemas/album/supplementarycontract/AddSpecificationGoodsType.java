...
import ru.acs.fts.schemas.album.commercialfinancecommonaggregatetypescust.AdditionalGoodsDescriptionType;
...
/** 
 * Описание товаров из спецификации к дополнению к контракту
 */
public class AddSpecificationGoodsType
{
