 ...
 */
public class RUESADCommonOfficialMarkType
{
    ...
    /** 
     * Get the 'Code' element value. Цифровой код валюты денежных средств / Код единицы измерения / Буквенный код страны Примечание: код страны заполняется для кода типа информации "34"/ Буквенный код валюты (при указании фактурной стоимости) / Код основания продления срока выпуска товаров 
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'Code' element value. Цифровой код валюты денежных средств / Код единицы измерения / Буквенный код страны Примечание: код страны заполняется для кода типа информации "34"/ Буквенный код валюты (при указании фактурной стоимости) / Код основания продления срока выпуска товаров 
     * 
     * @param code
     */
