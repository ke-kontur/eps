...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.1.0" xmlns:ESADout_CU="urn:customs.ru:Information:CustomsDocuments:ESADout_CU:5.1.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.1.0" xmlns:cltESAD_cu="urn:customs.ru:CUESADCommonLeafTypes:5.0.7" xmlns:goom="urn:customs.ru:Information:CustomsDocuments:GTDOutCustomsMark:5.1.0" exclude-result-prefixes="xs xsi ESADout_CU goom">
	<xsl:output method="xml" encoding="UTF-8" indent="yes"/>
	<xsl:template match="/">
		<xsl:variable name="GTD" select="//goom:GTDOutCustomsMark"/>
		<xsl:for-each select="//ESADout_CU:ESADout_CU">
			<esif:ESADInfo DocumentModeID="1006151E" xmlns:esif="urn:customs.ru:Information:CustomsDocuments:ESADInfo:5.1.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.1.0" xmlns:cltESAD_cu="urn:customs.ru:CUESADCommonLeafTypes:5.0.7">
				<cat_ru:DocumentID/>
