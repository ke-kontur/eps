...
/** 
 * –егистрационные сведени€ о документе, на основании которого осуществл€етс€ таможенное декларирование
 * 
...
public class CustomsDocumentType
{
    ...
    /** 
     * Get the 'DocNumber' element value. Ќомер документа
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'DocNumber' element value. Ќомер документа
     * 
     * @param docNumber
     */
