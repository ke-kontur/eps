...
public class MessageCMN12092BusinessProcess extends BusinessProcess
{
	@Override
		...
		throws Exception
	{
		...
		InventoryType doc = recvEnv.getDocument( ).getDocumentAsClass( InventoryType.class );
		
		List< InventDocumentType > docs = doc.getInventoryInstance( ).getInventDocumentList( );		
		...
		messageTypeSubstituion.put( recvEnv.getMessageType( ), MessageType.MSG_12003 );
		...
		respEnvelope.getDocument( ).setIncomeDocumentID( recvEnv.getDocument( ).getDocumentID( ) );
