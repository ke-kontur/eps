...
public class CustomsGuaranteeDocType extends DocumentBaseType
{
    ...
    /** 
     * Get the 'DocumentKind' element value. Тип документа, по которому осуществляется перевозка товаров/Тип документа обеспечения: 1 - ДТ; 2 - ТД; 3 - книжка МДП; 4 - Сертификат; 5 - ТПО; 6 - ТР; 7 - дополнение к договору поручительства; 8 - банковская гарантия
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'DocumentKind' element value. Тип документа, по которому осуществляется перевозка товаров/Тип документа обеспечения: 1 - ДТ; 2 - ТД; 3 - книжка МДП; 4 - Сертификат; 5 - ТПО; 6 - ТР; 7 - дополнение к договору поручительства; 8 - банковская гарантия
     * 
     * @param documentKind
     */
