...
class BaseStorage< T >
{
		...
		throws DatabaseException
	{
		try
		{
			return _jpaTemplate.execute( new JpaCallback< Integer >( )
			{
		...
		throws DatabaseException
	{
		try
		{
			_jpaTemplate.execute( new JpaCallback< Object >( )
			{
	...
	public CursoredStream selectCursor( final String query, final Map< String, Object > arguments )
		throws DatabaseException
	{
		try
		{
			return _jpaTemplate.execute( new JpaCallback< CursoredStream >( )
			{
				public CursoredStream doInJpa( EntityManager em ) throws PersistenceException
				{
		...
		{
			throw new DatabaseException( "BaseStorage.selectCursor failed", exc );
		}
	}
