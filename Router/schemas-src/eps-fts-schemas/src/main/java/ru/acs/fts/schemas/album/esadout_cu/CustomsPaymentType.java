...
public class CustomsPaymentType extends ESADoutCUCustomsPaymentType
{
    ...
    private PaymentDocumentType paymentDocument;
     ...
     * @return value
     */
    public PaymentDocumentType getPaymentDocument() {
     ...
     */
    public void setPaymentDocument(PaymentDocumentType paymentDocument) {
