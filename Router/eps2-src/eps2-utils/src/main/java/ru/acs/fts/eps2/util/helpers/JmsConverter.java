...
import ru.acs.fts.eps2.util.exceptions.JmsConverterException;
		...
		throws JmsConverterException
	{
		...
		try 
		{
			...
			else
			{
				...
				log.error( errorMsg );
				throw new JmsConverterException( errorMsg );
			}
		} 
		catch ( JMSException e ) 
		{
			...
			throw new JmsConverterException( errorMsg, e );
		}		
