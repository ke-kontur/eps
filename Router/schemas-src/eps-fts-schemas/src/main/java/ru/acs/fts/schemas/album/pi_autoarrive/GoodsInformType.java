...
/** 
 * »нформаци€ о перевозимых товарах
 */
public class GoodsInformType
{
    ...
    /** 
     * Get the 'TotalGoodsNameQuantity' element value. ¬сего наименований товаров
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'TotalGoodsNameQuantity' element value. ¬сего наименований товаров
     * 
    ...
    /** 
     * Get the 'ShipSpecifQuantity' element value.  оличество отгрузочных спецификаций
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'ShipSpecifQuantity' element value.  оличество отгрузочных спецификаций
     * 
    ...
    /** 
     * Get the 'ShipSpecifGoodsQuantity' element value.  оличество товаров по отгрузочным спецификаци€м
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'ShipSpecifGoodsQuantity' element value.  оличество товаров по отгрузочным спецификаци€м
     * 
    ...
    /** 
     * Get the list of 'Goods' element items. —ведени€ о товарах
     * 
     * @return list
     */
    ...
    /** 
     * Set the list of 'Goods' element items. —ведени€ о товарах
     * 
     * @param list
     */
