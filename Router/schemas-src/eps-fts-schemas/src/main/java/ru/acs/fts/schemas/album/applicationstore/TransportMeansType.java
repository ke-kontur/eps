...
public class TransportMeansType
{
    ...
    /** 
     * Get the 'TransportIdentifier' element value. »дентификационные сведени€ о транспортном средстве
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'TransportIdentifier' element value. »дентификационные сведени€ о транспортном средстве
     * 
