...
/** 
 * –егистрационный номер ƒ“/ иного таможенного документа, на основании которого осуществл€етс€ таможенное декларирование
 */
public class CustomsDocumentType
{
    ...
    /** 
     * Get the 'DocNumber' element value. ”никальный номер документа
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'DocNumber' element value. ”никальный номер документа
     * 
     * @param docNumber
     */
