...
public class InventDocumentType
{
    ...
    /** 
     * Get the 'InvDocCode' element value. Код вида представляемого документа. Заполняется согласно Классификатору из Приложения 16 "Классификаторов видов документов, используемых при заявлении сведений в графе 44"  При отсутствии соответствующего кода в классификаторе проставляется значение "0000".
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'InvDocCode' element value. Код вида представляемого документа. Заполняется согласно Классификатору из Приложения 16 "Классификаторов видов документов, используемых при заявлении сведений в графе 44"  При отсутствии соответствующего кода в классификаторе проставляется значение "0000".
     * 
     * @param invDocCode
     */
