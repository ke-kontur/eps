...
public class GTDObligationINType extends BaseDocType
{
    ...
    private ConfPaytDocumentsType customsMark;
    private InfoCustomsPayType infoCustomsPay;
    private GTDIDType obligationRegNumber;
    ...
    private List<ServiceMarksType> serviceMarkList = new ArrayList<ServiceMarksType>();
     ...
     * @param custMarkSign
     */
    public void setCustMarkSign(String custMarkSign) {
        this.custMarkSign = custMarkSign;
    }
     ...
     * @return value
     */
    public ConfPaytDocumentsType getCustomsMark() {
        return customsMark;
    }
     ...
     * @param customsMark
     */
    public void setCustomsMark(ConfPaytDocumentsType customsMark) {
     ...
     * @return value
     */
    public GTDIDType getObligationRegNumber() {
        return obligationRegNumber;
    }
     ...
     */
    public void setObligationRegNumber(GTDIDType obligationRegNumber) {
        this.obligationRegNumber = obligationRegNumber;
    }
     ...
     * @return list
     */
    public List<ServiceMarksType> getServiceMarkList() {
        return serviceMarkList;
    }
     ...
     * @param list
     */
    public void setServiceMarkList(List<ServiceMarksType> list) {
        serviceMarkList = list;
    }
