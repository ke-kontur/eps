...
public class MessageCMN11147BusinessProcess extends BusinessProcess
{
	 ...
	 */
	private void changePreviousContainerStates( String processID)
		throws DatabaseException
	{
        List<Edecl_Messages> messagesList = _serviceHolder.getEnvelopeService( ).getMessagesByProcessIdForCMN11146WithCurrentDocuments(processID);
        for( Edecl_Messages msg : messagesList ){
            Edecl_Msg_Doc previousContainerDoc = _serviceHolder.getEnvelopeService( ).getDocument( msg.getDocumentId() );
            ...
            List< Edecl_Msg_Doc > previousInnerDocs = _serviceHolder.getEnvelopeService( )
                    .getContainerDocuments( msg.getDocumentId() );
