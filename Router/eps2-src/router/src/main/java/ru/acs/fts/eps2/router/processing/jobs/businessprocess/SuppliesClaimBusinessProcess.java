...
public class SuppliesClaimBusinessProcess extends BusinessProcess
{
	@Override
		...
		throws Exception
	{
		...
		ApplicationStoreType applicationStore = 
			recvEnv.getDocument( ).getDocumentInContainer( ApplicationStoreType.class ).getDocumentAsClass( ApplicationStoreType.class );
		
		process.setTransferType( applicationStore.getMoveDirection( ) );
		process.setCustProcedureCode( applicationStore.getCustomsModeCode( ) );
